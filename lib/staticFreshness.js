...
const STATIC_PAGES = [
  { path: '/',                       file: 'public/home.html',                    baseline: '2026-07-06', priority: '1.0', changefreq: 'weekly'  },
  { path: '/features',               file: 'public/features.html',                baseline: '2026-07-06', priority: '0.9', changefreq: 'monthly' },
  { path: '/pricing',                file: 'public/pricing.html',                 baseline: '2026-07-06', priority: '0.9', changefreq: 'monthly' },
  { path: '/about',                  file: 'public/about.html',                   baseline: '2026-07-06', priority: '0.7', changefreq: 'monthly' },
  { path: '/contact',                file: 'public/contact.html',                 baseline: '2026-07-06', priority: '0.6', changefreq: 'monthly' },
  { path: '/ai-roleplay',            file: 'public/ai-roleplay.html',             baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/managers',               file: 'public/managers.html',                baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/teams',                  file: 'public/teams.html',                   baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/demo',                   file: 'public/demo.html',                    baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/checklist',              file: 'public/checklist.html',               baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/scholarship',            file: 'public/scholarship.html',             baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/affiliates',             file: 'public/affiliates.html',              baseline: '2026-07-06', priority: '0.7', changefreq: 'monthly' },
  { path: '/novels',                 file: 'public/novels-series.html',           baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/novels/first-crossings', file: 'public/novels-first-crossings.html',  baseline: '2026-07-06', priority: '0.8', changefreq: 'monthly' },
  { path: '/blog',                   file: 'public/blog/index.html',              baseline: '2026-07-06', priority: '0.8', changefreq: 'weekly'  },
];
