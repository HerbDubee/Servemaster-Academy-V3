(function () {
  ...
  var config = {
    'bartending':    { label: 'Barman',               color: '#fbbf24', bg: 'rgba(251,191,36,0.12)'  },
    'server-skills': { label: 'Compétences serveur',   color: '#34d399', bg: 'rgba(52,211,153,0.12)'  },
    'management':    { label: 'Direction',              color: '#60a5fa', bg: 'rgba(96,165,250,0.12)'  }
  };
  ...
  a.setAttribute('aria-label', 'Parcourir tous les articles : ' + c.label);
  a.style.cssText = [
