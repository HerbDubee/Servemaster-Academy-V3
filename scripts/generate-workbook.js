...
const CHAPTERS = [
  ...
  },
  {
    ...
    summary: `Luca Voss, shaped by his engineer father's precision and his Amalfi mother's instinct for people, is three months into a stage at Plénitude. When the pigeon course is delayed two minutes, he doesn't wait — he bridges the table with a 2015 Clos de Tart, turning the gap into a gift. After service he writes three words: "Precision and warmth. Not opposites."`,
    mc: [
      ...
      { q: 'The Clos de Tart is from which appellation?', opts: ['Gevrey-Chambertin', 'Chambolle-Musigny', 'Morey-Saint-Denis', 'Pommard'], ans: 2, explain: 'Clos de Tart is a grand cru monopole in Morey-Saint-Denis, Côte de Nuits. Luca describes it as "violet and earth, nothing heavy."' },
  ...
  },
  {
    ...
    mc: [
      ...
      { q: "On her last shift, Quim's parting advice to Sofia is to apply to:", opts: ["El Bulli (Ferran Adrià's legendary restaurant)", "Tickets (Albert Adrià's Barcelona spot)", 'Disfrutar (three stars, Oriol Castro\'s team)', 'La Boqueria (the central market)'], ans: 2, explain: '"You got the speed." Quim is pointing her from controlled chaos toward the precision end of the spectrum.' },
    ],
  ...
  },
  {
    ...
    mc: [
      ...
      { q: 'Chassagne-Montrachet is:', opts: ['A red Burgundy from the Côte de Nuits', 'A white Burgundy from the Côte de Beaune', 'A Champagne-method sparkling wine from the Mâconnais', 'A Loire Valley Chenin Blanc'], ans: 1, explain: "Chassagne-Montrachet is a premier and grand cru village appellation on the Côte de Beaune, producing some of Burgundy's finest Chardonnays." },
  ...
  },
  {
    ...
    mc: [
      ...
      { q: 'For the plantain gnocchi at Ikoyi, Luca pairs:', opts: ['White Burgundy (Chardonnay)', 'South African Chenin Blanc', 'Australian Riesling', 'Spanish Albariño'], ans: 1, explain: 'South African Chenin Blanc — stone fruit to echo the caramelised plantain edge, enough acidity to cut the fermented shrimp butter.' },
  ...
  },
  {
    ...
    mc: [
      { q: 'Sofia describes the Rioja as pairing well with jamón because:', opts: ['They come from the same region and share terroir characteristics', "The wine's tannins cut the fat of the cured meat — a structural pairing", "It's the lightest red on the list and won't overwhelm the flavour", 'The producer specifically recommends it in their tasting notes'], ans: 1, explain: '"The tannins cut the fat of the jamón" — tannin in the wine binds to fat protein in the jamón, cleansing the palate. This is why red wine and charcuterie work.' },
      ...
      { q: 'Priorat is a wine region located in:', opts: ['The Rioja DOC, near Logroño', 'Castile-La Mancha, in central Spain', 'Catalonia, in north-eastern Spain', 'Andalusia, near Jerez'], ans: 2, explain: 'Priorat (or Priorato) is a DOCa in Catalonia known for intense mineral red wines from old Grenache and Carignan vines on llicorella (slate) soils.' },
  ...
  },
  {
    ...
    mc: [
      ...
      { q: '"Offering to the room rather than at the room" describes a service posture where:', opts: ['The server speaks loudly enough for all guests to hear', 'The presentation feels like shared discovery rather than a sales pitch directed at one person', 'The server allows guests to serve themselves from a central platter', 'The maître d\' makes all wine decisions on behalf of the table'], ans: 1, explain: 'This phrase appears first in Chapter 1 and anchors the book\'s service philosophy. The difference between a pitch and an invitation is entirely in the posture of the person making it.' },
    ],
