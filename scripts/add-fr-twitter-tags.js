...
const OLD_TWITTER_BLOCK_RE = /\n    <meta name="twitter:card"[^\n]*(?:\n    <meta name="twitter:[^"]*"[^\n]*)*/g;

const STANDALONE_OG_TITLE_RE = /\n  <meta property="og:title"[^\n]*/g;
const STANDALONE_OG_DESC_RE = /\n  <meta property="og:description"[^\n]*/g;
...
for (const file of files) {
  ...
  html = html.replace(OLD_TWITTER_BLOCK_RE, '');
  html = html.replace(STANDALONE_OG_TITLE_RE, '');
  html = html.replace(STANDALONE_OG_DESC_RE, '');
