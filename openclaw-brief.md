# ServeMaster Academy — OpenClaw Marketing Brief

**Platform:** servemasteracademy.ca
**Founder:** Kirk Adamson — kirk_adamson@servemasteracademy.ca
**Brand colours:** #FF5E3A (orange), #0A4D68 (teal)
**Brand fonts:** Montserrat (headings), Inter (body)
**Languages:** English, French, Spanish (EN primary)
...
### Audience 1: Individual Servers

**Who they are:** Restaurant servers aged 19–35, 0–5 years experience, working in casual to mid-range dining and aspiring to move up to fine dining or increase their earnings.

**Their motivation:** More tips, better jobs, career legitimacy. They want to be taken seriously as a professional. They feel undertrained and undervalued.
...
- Premium Annual: $149 CAD/year (save 35%)

**Content tone for this audience:** Aspirational, peer-level, honest. Not corporate. Speak to ambition, not just skill. "You deserve to earn what a great server earns."
...
**Their hesitation:** They've tried in-house training before and it didn't stick. They're skeptical of software that promises to train their team. They want proof before committing.
...
## Content Brief for OpenClaw

### Primary Goal (Months 1–2)
Drive individual server sign-ups. The individual funnel is shorter, cheaper to convert, and builds the community that eventually sells team plans.

### Secondary Goal (Months 2–4)
Build manager awareness through LinkedIn and partner channels. Managers research solutions — they need to find ServeMaster before they go looking elsewhere.

---

### Content Pillars

**Pillar 1: Career Transformation**
Stories, tips, and facts about what separates servers who earn $30K/year from those who earn $60K+. This audience exists on TikTok, Instagram, and Facebook.
...
| Channel | Primary Audience | Content Type | Frequency |
|---|---|---|---|
| TikTok | Individual servers | Short-form, authentic, career tips | 4–5x/week |
| Instagram | Individual servers | Visual tips, reels, stories | 3–4x/week |
| Facebook | Servers 25+, managers | Mix of tips and ROI content | 3x/week |
| LinkedIn | Managers, operators, HR | Professional, ROI, case study | 3x/week |
| LinkedIn Articles | Managers, operators | Long-form thought leadership | 1x/week |
| Email Newsletter | Opted-in list | Weekly tips + platform updates | 1x/week |

---

## UTM Naming Conventions

All links shared on social, email, or partner channels must use UTM parameters so GA4 can attribute traffic correctly.

### Format
```
https://servemasteracademy.ca/?utm_source=SOURCE&utm_medium=MEDIUM&utm_campaign=CAMPAIGN&utm_content=CONTENT
```
...
- `article` (LinkedIn articles, blog posts)
- `email` (email campaigns)
- `video` (YouTube, TikTok, Reels)
- `partner` (partner referral links)

### utm_campaign values
Use the format `TOPIC_MONTH_YEAR`, e.g.:
- `career_tips_2026_04`
- `manager_roi_2026_04`
- `scholarship_2026_04`
...
Approved affiliates get a unique referral link (`servemasteracademy.ca/?ref=YOURCODE`). When someone clicks their link and subscribes, the affiliate earns:

| Plan | Commission |
|---|---|
| Premium Monthly ($19) | $4.75 (25%) |
| Premium Annual ($149) | $37.25 (25%) |
| Starter Team Monthly ($99) | $29.70 (30%) |
| Starter Team Annual ($990) | $297 (30%) |
| Pro Team Monthly ($199) | $59.70 (30%) |
| Pro Team Annual ($1,990) | $597 (30%) |

**One-time bonuses on first sale:**
- $100 Welcome Bonus on first qualifying sale ever
- $75 Team Activation Bonus on first team plan sale

Minimum payout: $50 CAD. Payouts on the 1st of each month via PayPal, Wise, or bank transfer.

**Apply at:** servemasteracademy.ca/affiliates

Ideal affiliates: hospitality creators, culinary school instructors, restaurant industry podcasters, food & service bloggers.

---

## The Scholarship Program

The Career Launch Scholarship gives 15 motivated servers per month 60 days of full premium access — completely free.

**Why it matters for marketing:**
- It builds authentic social proof (real people, real results)
...
- `subscription_complete` — Stripe checkout completed

Use Contentsquare to monitor:
- Scroll depth on homepage, pricing, and /teams
- CTA click rates and dead clicks on key pages
- Form abandonment on /signup
- Session replays for users who reach pricing but don't convert
